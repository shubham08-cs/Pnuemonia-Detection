#!/usr/bin/env python3
"""Script to write a clean helpers.py file."""

import os

helpers_content = '''"""Helper functions for pneumonia detection application."""
...
helpers_path = r"e:\Projects\Pneumonia Detection\app\helpers.py"
...
print(f"✓ helpers.py written successfully ({len(helpers_content)} bytes)")
